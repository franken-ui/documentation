...
<link
  rel="stylesheet"
  href="https://unpkg.com/franken-wc@0.1.1/dist/css/zinc.min.css"
/>
```

You can replace `zinc` with 11 other colors:  <code class="uk-codespan">slate</code>, <code class="uk-codespan">stone</code>, <code class="uk-codespan">gray</code>, <code class="uk-codespan">neutral</code>, <code class="uk-codespan">red</code>, <code class="uk-codespan">rose</code>, <code class="uk-codespan">orange</code>, <code class="uk-codespan">green</code>, <code class="uk-codespan">blue</code>, <code class="uk-codespan">yellow</code>, <code class="uk-codespan">violet</code>
