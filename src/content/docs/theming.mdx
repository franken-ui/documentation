...
To register your newly added palette with the [Theme Switcher](/docs/theme-switcher#custom-palette), please refer to the corresponding documentation or guide for step-by-step instructions on how to integrate it.