...
title: Upgrade Guide
meta:
  description: "A comprehensive guide on how to upgrade to the latest version of Franken UI."
---
...
Make sure to follow the new [installation guide](/docs/installation) and then follow the upgrade guide.
