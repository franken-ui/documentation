...
At the moment, version 1.1 is tagged as `next` until the documentation has been completed. Testing is now available, and feedback can be provided on Github if something is broken.

```sh
npm i franken-ui@next
```
...
<link
  rel="stylesheet"
  href="https://unpkg.com/franken-ui@1.1.0-next.0/dist/css/core.min.css"
/>

<!-- JavaScript -->

<script src="https://unpkg.com/franken-ui@1.1.0-next.0/dist/js/core.iife.js" type="module"></script>
<script src="https://unpkg.com/franken-ui@1.1.0-next.0/dist/js/icon.iife.js" type="module"></script>
```
...
**2\.** Remove the dark mode switcher to make the most out of the new Theme Switcher component:
...
<div class="uk-inline">
    ...
    <div class="uk-drop w-96" uk-drop="mode: click; offset: 8">
