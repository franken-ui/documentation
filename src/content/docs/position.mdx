...
<span class="uk-label uk-label-primary">Note</span> This is often used to
position an overlay from the [Overlay component](/docs/overlay).
...
scrollbar. Use the [Visibility component](/docs/visibility) to hide the outside
