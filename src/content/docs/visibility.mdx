...
text: Visibility
title: Visibility
lead: Use responsive visibility classes to display or hide elements on different devices.
wip: true
meta:
  robots: noindex
...
<span class="uk-label uk-label-primary">Note</span> In this example the green
elements are hidden on screens that are larger than the defined breakpoint.
...
<span class="uk-label uk-label-primary">Note</span> In this example the green
elements are displayed on screens that are larger than the defined breakpoint.
Resize your browser window to see the effect.
