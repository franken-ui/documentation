...
text: Grid
title: Grid
lead: Create a fully responsive, fluid and nestable grid layout.
meta:
...
<span class="uk-label uk-label-primary">Note</span> There's no need to add a
`.uk-grid` class as it will be added via JavaScript. However, if UIkit's
JavaScript is
[deferred](https://developer.mozilla.org/docs/Web/HTML/Element/script#attr-defer),
...
<span class="uk-label uk-label-primary">Note</span> Often cards from the [Card
component](/docs/card) are used inside a grid. This also goes for the following
...
<span class="uk-label uk-label-primary">Note</span> You can view more examples
in the tests for the [Grid Masonry](../assets/uikit/tests/grid-masonry.html).
...
<span class="uk-label uk-label-primary">Note</span> You can view more examples
in the [Grid Parallax](../assets/uikit/tests/grid-parallax.html) tests.
...
Grid component within the `ui()` plugin.
...
| ------------------------- | ---------------------------------------------------------- |
| `hook-divider-horizontal` | `.uk-grid-divider > :not(.uk-first-column)::before`        |
| `hook-divider-vertical`   | `.uk-grid-divider.uk-grid-stack > .uk-grid-margin::before` |
| `hook-misc`               | `*`                                                        |
