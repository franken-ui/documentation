...
```html
<script src="https://unpkg.com/franken-ui@2.0.0-internal.0/dist/js/core.iife.js" type="module"></script>
<script src="https://unpkg.com/franken-ui@2.0.0-internal.0/dist/js/icon.iife.js" type="module"></script>
```
